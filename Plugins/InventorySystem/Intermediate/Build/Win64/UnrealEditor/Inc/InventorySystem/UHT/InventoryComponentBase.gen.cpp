...
void FOnInventoryItemSelected_DelegateWrapper(const FMulticastScriptDelegate& OnInventoryItemSelected, TScriptInterface<IInteractibleItemInterface> const& Value)
{
	...
	struct Z_CompiledInDeferFile_FID_UnrealProjects_XCityNew_XCITY_Plugins_InventorySystem_Source_InventorySystem_Public_Conponents_InventoryComponentBase_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_XCityNew_XCITY_Plugins_InventorySystem_Source_InventorySystem_Public_Conponents_InventoryComponentBase_h_Statics::ClassInfo[] = {
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_XCityNew_XCITY_Plugins_InventorySystem_Source_InventorySystem_Public_Conponents_InventoryComponentBase_h_2841306366(TEXT("/Script/InventorySystem"),
		Z_CompiledInDeferFile_FID_UnrealProjects_XCityNew_XCITY_Plugins_InventorySystem_Source_InventorySystem_Public_Conponents_InventoryComponentBase_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UnrealProjects_XCityNew_XCITY_Plugins_InventorySystem_Source_InventorySystem_Public_Conponents_InventoryComponentBase_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
