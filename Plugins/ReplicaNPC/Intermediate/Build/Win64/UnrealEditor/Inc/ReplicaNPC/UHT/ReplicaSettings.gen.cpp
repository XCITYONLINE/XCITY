...
// End Cross Module References
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UReplicaSettings_Statics::DependentSingletons) < 16);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UClass_UReplicaSettings_Statics::NewProp_API_Key = { "API_Key", nullptr, (EPropertyFlags)0x0040000000004001, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UReplicaSettings, API_Key), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UReplicaSettings_Statics::NewProp_API_Key_MetaData), Z_Construct_UClass_UReplicaSettings_Statics::NewProp_API_Key_MetaData) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UReplicaSettings_Statics::ClassParams = {
		...
		0,
		0x001000A6u,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UReplicaSettings_Statics::Class_MetaDataParams), Z_Construct_UClass_UReplicaSettings_Statics::Class_MetaDataParams)
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UReplicaSettings_Statics::PropPointers) < 2048);
	...
	UReplicaSettings::UReplicaSettings(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer) {}
	DEFINE_VTABLE_PTR_HELPER_CTOR(UReplicaSettings);
	UReplicaSettings::~UReplicaSettings() {}
	struct Z_CompiledInDeferFile_FID_UnrealProjects_XCityNew_XCITY_Plugins_ReplicaNPC_Source_ReplicaNPC_Public_ReplicaSettings_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_XCityNew_XCITY_Plugins_ReplicaNPC_Source_ReplicaNPC_Public_ReplicaSettings_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UReplicaSettings, UReplicaSettings::StaticClass, TEXT("UReplicaSettings"), &Z_Registration_Info_UClass_UReplicaSettings, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UReplicaSettings), 4197090557U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_XCityNew_XCITY_Plugins_ReplicaNPC_Source_ReplicaNPC_Public_ReplicaSettings_h_3667585959(TEXT("/Script/ReplicaNPC"),
		Z_CompiledInDeferFile_FID_UnrealProjects_XCityNew_XCITY_Plugins_ReplicaNPC_Source_ReplicaNPC_Public_ReplicaSettings_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UnrealProjects_XCityNew_XCITY_Plugins_ReplicaNPC_Source_ReplicaNPC_Public_ReplicaSettings_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
