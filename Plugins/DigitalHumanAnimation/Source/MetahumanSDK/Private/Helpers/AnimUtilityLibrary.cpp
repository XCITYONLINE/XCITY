...
float FAnimUtilityLibrary::EvaluateCurveValue(const UAnimSequence* AnimSequence, FName CurveName, const int32 FrameIdx)
{
	...
	return AnimSequence->EvaluateCurveData(CurveName, CurrentTime);
}
