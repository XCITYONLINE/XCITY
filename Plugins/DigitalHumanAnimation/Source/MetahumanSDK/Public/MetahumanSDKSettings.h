...
public:
    ...
    const FString GetWebAccountUrl() const;
    
private:
    FString PluginVersion = "";
    const FString WebAccountUrl = "https://space.metahumansdk.io";
...
public:
    ...
    /** Enabled compression could decrease server response time and animation quality. It is currently supported after TTS and loading sound from file. */
    UPROPERTY(Config, EditAnywhere, Category = "MetahumanSDKSettings")
    bool bCompressSound = false;
};
