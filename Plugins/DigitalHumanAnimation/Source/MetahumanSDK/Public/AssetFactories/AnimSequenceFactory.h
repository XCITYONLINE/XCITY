...
private:
    ...
    static void UpdateAnimCurveTracks(FRawCurveTracks& AnimCurveTracks, const TMap<FName, float>& CurveWeightedValues, const float InTime, const TArray<FName> SkeletonCurveNames,
