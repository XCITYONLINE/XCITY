...
public:
    ...
    //UFUNCTION(BlueprintCallable, Category = "MetahumanSDKAPIManager", meta = (Latent, LatentInfo = "LatentInfo", HidePin = "WorldContextObject", DefaultToSelf = "WorldContextObject"))
    //void ATLStreamAudioToLipsync(const FMetahumanSDKATLInput& ATLInput, bool& bResponseSuccess, FMetahumanSDKATLOutput& ATLOutput, FString& Error, FLatentActionInfo LatentInfo, UObject* WorldContextObject = nullptr);
