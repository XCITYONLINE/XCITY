...
void FOnProjectileHit_DelegateWrapper(const FMulticastScriptDelegate& OnProjectileHit, FHitResult const& Value)
{
	...
	struct Z_CompiledInDeferFile_FID_UnrealProjects_XCityNew_XCITY_Plugins_WeaponSystem_Source_WeaponSystem_Public_WeaponActors_AmmoProjectileBase_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_XCityNew_XCITY_Plugins_WeaponSystem_Source_WeaponSystem_Public_WeaponActors_AmmoProjectileBase_h_Statics::ClassInfo[] = {
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_XCityNew_XCITY_Plugins_WeaponSystem_Source_WeaponSystem_Public_WeaponActors_AmmoProjectileBase_h_1740593591(TEXT("/Script/WeaponSystem"),
		Z_CompiledInDeferFile_FID_UnrealProjects_XCityNew_XCITY_Plugins_WeaponSystem_Source_WeaponSystem_Public_WeaponActors_AmmoProjectileBase_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UnrealProjects_XCityNew_XCITY_Plugins_WeaponSystem_Source_WeaponSystem_Public_WeaponActors_AmmoProjectileBase_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
